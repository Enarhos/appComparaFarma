...
| v15-05 | Indicador de filtro activo en Resultados (chip dismissible) | Alto | Bajo | ❌ Pendiente | Solo hay un badge agregado "Filtros (N)" en el botón, no un chip por filtro individual |
...
| v15-07 | Mensaje en primer snapshot de historial de precio | Alto | Bajo | ❌ Pendiente | Con < 2 snapshots simplemente no se renderiza nada, sin explicación |
