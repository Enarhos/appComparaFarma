...
| **2a** | Web con SEO (Next.js) 🟡 **código completo y verificado (2026-07-20)** — Home + `/buscar/[query]` con metadata dinámica, consumiendo el mismo `api/`. Falta: crear el proyecto en Vercel y deployar | Fase 1 (DB) | No — proyecto nuevo `web/`, separado |
