...
| Frontera entre identidad y producto | `docs/brand/BRAND_GUIDELINES.md` §4.5 | Ninguna familia de este catálogo redefine una decisión de marca; cada familia de Foundation Tokens (§4.3) es una traducción, nunca una decisión nueva |
...
| Typography | Traducir cada una de las cinco capas tipográficas (Display, Heading, Body, Caption, Data/Numeric) | `docs/brand/TYPOGRAPHY_SYSTEM.md` §4.2 |
| Color | Traducir cada una de las siete capas funcionales del color | `docs/brand/COLOR_SYSTEM.md` §4.2 |
| Iconography | Traducir cada una de las nueve categorías funcionales de iconografía | `docs/brand/ICONOGRAPHY_SYSTEM.md` §4.2 |
...
|---|---|---|
| Surface | Superficies de interfaz: fondos y contenedores sobre los que se organiza el contenido | Capa "Fondo" de `docs/brand/COLOR_SYSTEM.md` §4.2; Zonas de contenido de `docs/design-system/GRID_SYSTEM.md` §4.2.3 |
| Content | Contenido textual e icónico que ocupa una superficie | `docs/brand/TYPOGRAPHY_SYSTEM.md` §4.2; `docs/brand/ICONOGRAPHY_SYSTEM.md` §4.2 |
...
| Feedback | Respuesta visual a una acción o a un cambio de estado del sistema | Capa "Semántico" de `docs/brand/COLOR_SYSTEM.md` §4.2; distinción entre urgencia funcional y artificial de `docs/design/DESIGN_BRIEF.md` §4.10 |
| Interactive | Elementos que responden a una acción directa de la persona | Accesibilidad de espacio entre elementos interactivos de `docs/design-system/SPACING_SYSTEM.md` §4.6; Color de Énfasis de `docs/brand/COLOR_SYSTEM.md` §4.2.5 |
| Navigation | Orientación estructural dentro del producto | Región funcional de Navegación de `docs/design-system/GRID_SYSTEM.md` §4.3; concepto central "Orientación" (`docs/design/DESIGN_DECISION_LOG.md`, DD-001) |
| Data | Valores numéricos y de datos del producto (precios, cantidades, fechas) | Capa Data/Numeric de `docs/brand/TYPOGRAPHY_SYSTEM.md` §4.2; capa "Datos" de `docs/brand/COLOR_SYSTEM.md` §4.2.7, ya citada como ejemplo del rol de los Tokens en `docs/design-system/DESIGN_SYSTEM.md` §4.4 |
| Comparison | Presentación de opciones equivalentes entre farmacias dentro de una misma comparación | Neutralidad ya aplicada en `docs/design-system/GRID_SYSTEM.md` §4.8, `SPACING_SYSTEM.md` §4.2.3, `docs/brand/COLOR_SYSTEM.md` §4.5 y `docs/design-system/ELEVATION_SYSTEM.md` §4.7 — la familia donde más aplicaciones de Neutralidad convergen, y por eso la que exige mayor disciplina de uso uniforme |
...
| Foundation tipográfica | `docs/brand/TYPOGRAPHY_SYSTEM.md` §4.2 | ✔ — familia "Typography" (§4.3) | — |
| Foundation de color | `docs/brand/COLOR_SYSTEM.md` §4.2 | ✔ — familia "Color" (§4.3) | — |
| Foundation de iconografía | `docs/brand/ICONOGRAPHY_SYSTEM.md` §4.2 | ✔ — familia "Iconography" (§4.3) | — |
...
| Concepto central "Orientación" | `docs/design/DESIGN_DECISION_LOG.md`, DD-001 | ✔ — fundamenta la familia "Navigation" (§4.4) | — |
