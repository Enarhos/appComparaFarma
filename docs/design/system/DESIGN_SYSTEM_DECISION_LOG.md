...
| **Nivel de Gobierno** | De decisión operativa — mismo nivel ya reconocido en `docs/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` §8 y aplicado, por precedente directo, a `docs/product/DECISION_LOG.md` y a `docs/design/DESIGN_DECISION_LOG.md` |
...
- La tabla oficial de decisiones de arquitectura del Design System, con sus columnas mínimas obligatorias (§4.1), idénticas en estructura a las de `docs/design/DESIGN_DECISION_LOG.md`.
...
- Decisiones de identidad de marca (concepto, isotipo, tipografía de marca, color, iconografía como sistemas de identidad). Corresponde exclusivamente a `docs/design/DESIGN_DECISION_LOG.md`.
- Decisiones de producto, backlog o roadmap. Corresponde exclusivamente a `docs/product/DECISION_LOG.md`.
...
Toda decisión de arquitectura del Design System registrada en este documento debe incluir, como mínimo, las siguientes columnas — misma estructura ya establecida en `docs/design/DESIGN_DECISION_LOG.md` §4.1:
...
Este documento depende de `docs/design-system/README.md` (dominio) y de los cuatro documentos de Foundation (`DESIGN_SYSTEM.md`, `SPACING_SYSTEM.md`, `GRID_SYSTEM.md`, `ELEVATION_SYSTEM.md`), cuya observación repetida sobre la ausencia de este registro es la fuente directa de DSG-001. Depende también de `docs/design-system/DESIGN_TOKEN_ARCHITECTURE.md`, `DESIGN_TOKENS.md`, `COMPONENT_LIBRARY.md`, `PATTERNS.md` y `SCREEN_TEMPLATES.md`, cada uno de los cuales ya declaró, en su propia versión 1.0, que una decisión de arquitectura propia requería aprobación y registro posterior — esa declaración explícita es la fuente directa de DSG-002 a DSG-007. Se relaciona, sin sustituirlo ni fusionarse con él, con `docs/design/DESIGN_DECISION_LOG.md` (mismo mecanismo de registro, aplicado a un dominio distinto: identidad de marca) y con `docs/product/DECISION_LOG.md` (mismo mecanismo, aplicado a decisiones de producto). Ninguna decisión puede registrarse en más de uno de estos tres registros — cada dominio tiene el suyo.
...
| Estructura de tabla de decisiones | `docs/design/DESIGN_DECISION_LOG.md` §4.1 | ✔ — misma estructura de columnas, aplicada a un dominio distinto | No se fusiona con el registro de marca; son dos tablas independientes |
| Decisiones de identidad de marca | `docs/design/DESIGN_DECISION_LOG.md` | No consolidado — dominio distinto | Este documento no registra decisiones de marca |
| Decisiones de producto y backlog | `docs/product/DECISION_LOG.md` | No consolidado — dominio distinto | Este documento no registra decisiones de producto |
...
- `docs/design/DESIGN_DECISION_LOG.md` — sigue siendo el único registro de decisiones de identidad de marca.
- `docs/product/DECISION_LOG.md` — sigue siendo el único registro de decisiones de producto.
