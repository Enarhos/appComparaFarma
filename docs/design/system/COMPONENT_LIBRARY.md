...
| Frontera entre identidad y producto | `docs/design/brand/BRAND_GUIDELINES.md` §4.5 | Ningún componente redefine una decisión de marca; solo consume los Tokens que ya la traducen (§4.3) |
...
| Identidad | Expresar un elemento de la identidad de marca dentro de la interfaz | `docs/design/brand/LOGO_SYSTEM.md`; categoría "Farmacias" de `docs/design/brand/ICONOGRAPHY_SYSTEM.md` §4.2 — con la misma restricción de Neutralidad ya señalada en ese documento |
...
| Frontera entre identidad y producto | `docs/design/brand/BRAND_GUIDELINES.md` §4.5 | ✔ — fundamenta §4.1 y §4.3 | — |
| Región funcional de Comparación y "hecho ya calculado" | `docs/design/system/GRID_SYSTEM.md` §4.3, §4.8; `docs/design/brand/COLOR_SYSTEM.md` §4.5 | ✔ — fundamenta la familia "Comparación" (§4.4) y la regla de destaque legítimo (§4.6) | — |
...
| Categoría "Farmacias" de iconografía | `docs/design/brand/ICONOGRAPHY_SYSTEM.md` §4.2 | ✔ — fundamenta la familia "Identidad" (§4.4) | Misma restricción de Neutralidad heredada |
...
| Patrón de evolución "trazar o justificar" | `docs/design/brand/BRAND_ARCHITECTURE.md` §4.7; `docs/design/system/DESIGN_SYSTEM.md` §4.8; `DESIGN_TOKEN_ARCHITECTURE.md` §4.5; `DESIGN_TOKENS.md` §4.8 | ✔ — aplicado al nacimiento de componentes (§4.8) | — |
...
- `docs/design/system/SPACING_SYSTEM.md`, `GRID_SYSTEM.md`, `ELEVATION_SYSTEM.md` y `docs/design/brand/TYPOGRAPHY_SYSTEM.md`, `COLOR_SYSTEM.md`, `ICONOGRAPHY_SYSTEM.md` — cada uno sigue siendo la única fuente de su propia Foundation.
