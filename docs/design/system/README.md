...
>
> Cierre declarado el 2026-08-06 (sprint `PROJECT-001`) — ver `docs/project/PROJECT_PHASES.md`. Incluye, sin limitarse a: `DESIGN_TOKENS.md`, `COMPONENT_LIBRARY.md`, `PATTERNS.md`, `SCREEN_TEMPLATES.md` y los Signature Components definidos en `docs/design/SIGNATURE_COMPONENTS.md`.
>
...
| **Nivel de Gobierno** | Chárter de Dominio — mismo nivel introducido en `docs/design/README.md` §1 y ya aplicado en `docs/brand/README.md` |
| **Clasificación** | Documento de Gobierno Documental |
| **Fuente Oficial** | Este mismo documento |
| **Documentos de los que depende** | `docs/design-system/DESIGN_SYSTEM.md`, `SPACING_SYSTEM.md`, `GRID_SYSTEM.md`, `ELEVATION_SYSTEM.md`, `DESIGN_SYSTEM_DECISION_LOG.md`, `docs/brand/BRAND_GUIDELINES.md`, `docs/templates/GOVERNED_DOCUMENT_TEMPLATE.md` |
...
|---|---|---|---|
| Frontera entre identidad y producto | `docs/brand/BRAND_GUIDELINES.md` §4.5 | ✔ (§2, §4.2) | Este dominio es el Design System anticipado por esa frontera |
...
| Reconocimiento formal del dominio en la plantilla de gobierno | `docs/templates/GOVERNED_DOCUMENT_TEMPLATE.md` v1.1 | ✔ — consistente con la actualización realizada en el mismo Sprint DG.001 | — |
...
- `docs/brand/BRAND_GUIDELINES.md` y los cuatro sistemas de identidad que integra.
