...
>
> Cierre declarado el 2026-08-06 (sprint `PROJECT-001`) — ver `docs/project/PROJECT_PHASES.md`. Incluye, sin limitarse a: `VISUAL_BENCHMARK.md`, `VISUAL_DIRECTION.md`, `COLOR_RESEARCH.md`, `VISUAL_EXPLORATION.md`, `BRAND_EXPERIENCE_V1.md`, `DISTINCTIVE_PRODUCT_IDENTITY.md`, `SIGNATURE_COMPONENTS.md`.
>
...
| **Nivel de Gobierno** | Chárter de Dominio — nivel introducido en este documento porque ninguno de los 6 niveles originales de `docs/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` §8, ni el nivel "Fundacional derivado" añadido por `docs/brand/BRAND_FOUNDATIONS.md`, describe un documento cuya función es declarar el alcance y las reglas de gobierno de una carpeta completa, sin ser en sí mismo contenido de negocio (ver §7, Gobierno, para el detalle) |
| **Clasificación** | Documento de Gobierno Documental |
| **Fuente Oficial** | Este mismo documento (es la fuente de su propio dominio); se apoya en `docs/brand/DESIGN_CONCEPT.md` (v1.0) para justificar la necesidad del dominio |
| **Documentos de los que depende** | `docs/brand/BRAND_FOUNDATIONS.md`, `docs/brand/VISUAL_IDENTITY.md`, `docs/brand/DESIGN_CONCEPT.md`, `docs/templates/GOVERNED_DOCUMENT_TEMPLATE.md` |
| **Documentos que gobierna** | `docs/design/DESIGN_EXPLORATION.md`, `docs/design/DESIGN_DECISION_LOG.md`, `docs/design/assets/README.md`, y todo documento futuro que se cree dentro de `docs/design/` |
...
- Quién es ComparaFarma, su personalidad, voz o tono. Corresponde a `docs/brand/BRAND_FOUNDATIONS.md`.
- Principios ni atributos de percepción visual. Corresponde a `docs/brand/VISUAL_IDENTITY.md`.
- El concepto visual central de la marca. Corresponde a `docs/brand/DESIGN_CONCEPT.md`.
- Ninguna decisión de diseño concreta (logo, color, tipografía). Esas decisiones, una vez tomadas, se registran en `docs/design/DESIGN_DECISION_LOG.md`, pero este documento no las contiene.
- El detalle de cada exploración creativa individual. Corresponde a `docs/design/DESIGN_EXPLORATION.md`.
...
- **Bitácoras de exploración creativa** — registros abiertos, no necesariamente resueltos, de sesiones de exploración conceptual o visual (`docs/design/DESIGN_EXPLORATION.md`).
- **Registros de decisiones de diseño** — el histórico oficial de qué se decidió, cuándo, por qué y con qué impacto (`docs/design/DESIGN_DECISION_LOG.md`).
...
- Cualquier documento que redefina quién es ComparaFarma, su misión, visión, principios, personalidad, voz o tono. Eso pertenece exclusivamente a `docs/brand/BRAND_FOUNDATIONS.md`, y `docs/design/` no tiene autoridad para modificarlo.
- Cualquier documento que declare principios de percepción visual o el concepto central de diseño como si fueran nuevos. Esos ya existen en `docs/brand/VISUAL_IDENTITY.md` y `docs/brand/DESIGN_CONCEPT.md`; `docs/design/` los usa, no los reescribe.
...
2. **Ningún activo gráfico es, por sí solo, una decisión oficial.** Una exploración, un moodboard o un logo en desarrollo solo se convierte en decisión de la organización cuando existe una entrada correspondiente en `docs/design/DESIGN_DECISION_LOG.md` (ver ese documento, y `docs/design/assets/README.md`).
3. **Ninguna exploración necesita concluir en una decisión.** Una entrada de `docs/design/DESIGN_EXPLORATION.md` puede quedar abierta indefinidamente. Cerrar prematuramente una exploración para llegar a una decisión contradice el criterio de éxito ya declarado en `docs/brand/DESIGN_CONCEPT.md` §7 (evitar resolver el diseño demasiado pronto).
4. **Toda decisión debe ser trazable a su fuente conceptual.** Ninguna entrada de `docs/design/DESIGN_DECISION_LOG.md` puede aprobarse sin citar el documento de `docs/brand/` (o la exploración de `docs/design/DESIGN_EXPLORATION.md`) que la justifica.
...
No existe relación directa entre `docs/design/` y la Arquitectura Empresarial (`docs/enterprise/`) ni con el Patrimonio Digital (`docs/strategy/DIGITAL_ASSET_REGISTER.md`), por el mismo motivo ya declarado en `docs/brand/BRAND_FOUNDATIONS.md` §20: esos dominios modelan capacidades, datos y servicios, no proceso creativo de marca.
...
|---|---|---|---|
| Concepto de diseño a materializar (Orientación) | `docs/brand/DESIGN_CONCEPT.md` §4.2 | Referencia — no se redefine | El dominio `docs/design/` lo usa como insumo de todo proceso de exploración |
| Principios y atributos de percepción visual | `docs/brand/VISUAL_IDENTITY.md` §4.2, §4.3 | Referencia — no se redefine | Idem |
| Identidad de marca (historia, misión, visión, principios, personalidad, voz, tono) | `docs/brand/BRAND_FOUNDATIONS.md` | Referencia — no se redefine | `docs/design/` no tiene autoridad para modificar estos conceptos |
...
| Existencia y ubicación del dominio `docs/design/` | — (vacío antes de este documento) | ✔ | Confirmado por inspección directa: la carpeta `docs/design/` no contenía, antes de este encargo, ningún documento de gobierno — solo un activo gráfico suelto (ver `docs/design/DESIGN_EXPLORATION.md`, EXP-001) |
...
- `docs/brand/BRAND_FOUNDATIONS.md` — identidad de marca.
- `docs/brand/VISUAL_IDENTITY.md` — principios y atributos de percepción visual.
- `docs/brand/DESIGN_CONCEPT.md` — concepto visual central y metáforas analizadas.
...
- `docs/brand/BRAND_AUDIT.md` — diagnóstico de origen de toda la Arquitectura de Marca.
- `docs/brand/BRAND_FOUNDATIONS.md` — identidad consolidada de ComparaFarma.
- `docs/brand/VISUAL_IDENTITY.md` — principios y atributos de percepción visual.
- `docs/brand/DESIGN_CONCEPT.md` — concepto visual central y metáforas analizadas.
- `docs/design/DESIGN_EXPLORATION.md` — bitácora de exploración creativa.
- `docs/design/DESIGN_DECISION_LOG.md` — registro oficial de decisiones de diseño.
...
|---|---|---|---|---|---|
| 1.0 | 2026-08-05 | Activo | Pendiente (CEO/fundador) | Creación inicial. Establece el dominio `docs/design/` como responsable de documentar el proceso completo de diseño de la marca (exploraciones, decisiones, activos), sin redefinir la identidad ya consolidada en `docs/brand/`. Introduce el nivel de gobierno "Chárter de Dominio". | `docs/brand/DESIGN_CONCEPT.md` v1.0; `docs/brand/VISUAL_IDENTITY.md` v1.0; `docs/brand/BRAND_FOUNDATIONS.md` v1.1; `docs/templates/GOVERNED_DOCUMENT_TEMPLATE.md` v1.0 |
...
| 2026-08-05 | Creación del dominio documental de proceso de diseño | Enterprise Documentation Architect / Design Governance Architect | `docs/design/README.md` v1.0 (este documento), `docs/design/DESIGN_EXPLORATION.md` v1.0, `docs/design/DESIGN_DECISION_LOG.md` v1.0, `docs/design/assets/README.md` v1.0 |

**Pendiente de definición:** ninguna de las acciones anteriores cuenta todavía con una aprobación formal registrada del CEO/fundador. El nuevo nivel de gobierno "Chárter de Dominio" queda sujeto a esa misma ratificación futura, al igual que su eventual incorporación formal a `docs/templates/GOVERNED_DOCUMENT_TEMPLATE.md`.
