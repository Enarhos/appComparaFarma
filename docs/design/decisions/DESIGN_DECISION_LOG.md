...
Este documento es el registro oficial de decisiones de diseño ya tomadas — no de exploraciones en curso (ver `docs/design/DESIGN_EXPLORATION.md` para eso) ni de activos gráficos sin resolución (ver `docs/design/assets/README.md`). Una decisión solo pertenece a este documento cuando ha sido efectivamente aprobada, con justificación documental y fuente citada.
...
| **Nivel de Gobierno** | De decisión operativa — mismo nivel ya reconocido en `docs/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` §8 y aplicado, por precedente directo, a `docs/product/DECISION_LOG.md` |
...
| **Documentos de los que depende** | `docs/design/README.md`, `docs/brand/DESIGN_CONCEPT.md`, `docs/design/DESIGN_EXPLORATION.md` |
...
- Exploraciones abiertas o en curso. Corresponde a `docs/design/DESIGN_EXPLORATION.md`.
- Reglas de almacenamiento de activos gráficos. Corresponde a `docs/design/assets/README.md`.
- El concepto central de diseño en sí mismo (solo registra la decisión de adoptarlo). La justificación completa del concepto vive en `docs/brand/DESIGN_CONCEPT.md`.
...
|---|---|---|---|
| Concepto central de diseño (Orientación) | `docs/brand/DESIGN_CONCEPT.md` §4.2 | ✔ — DD-001 | Aprobado para efectos de proceso de diseño; pendiente de ratificación final por CEO/fundador en su documento de origen |
| Familias exploradas en EXP-001 (Brújula, Mapa, Constelación) | `docs/design/DESIGN_EXPLORATION.md` | No consolidado — ninguna decisión tomada todavía | Explícitamente fuera de esta versión; EXP-001 permanece abierta |
...
`docs/design/DESIGN_DECISION_LOG.md` **no reemplaza** `docs/brand/DESIGN_CONCEPT.md` ni ningún otro documento de `docs/brand/`: solo registra que una decisión de proceso fue tomada con base en ellos. Toda fila de este registro que entre en conflicto con una futura revisión de `docs/brand/` debe marcarse como "Reemplazado", nunca editarse ni eliminarse — el historial de decisiones debe permanecer íntegro.
...
- `docs/brand/DESIGN_CONCEPT.md` — fuente de la decisión DD-001.
- `docs/design/DESIGN_EXPLORATION.md` — fuente de evidencia exploratoria para futuras decisiones.
- `docs/design/assets/README.md` — regla de que ningún activo es oficial sin una fila correspondiente en este documento.
- `docs/product/DECISION_LOG.md` — precedente de formato de registro de decisiones en otro dominio del repositorio.
...
| 2026-08-05 | Creación del dominio documental de proceso de diseño y registro de la primera decisión oficial de diseño | Enterprise Documentation Architect / Design Governance Architect | `docs/design/DESIGN_DECISION_LOG.md` v1.0 (este documento), con DD-001 |

**Pendiente de definición:** ninguna decisión de este registro cuenta todavía con una aprobación formal registrada del CEO/fundador más allá de la aprobación de proceso aquí documentada. DD-001 queda sujeta a la ratificación final que `docs/brand/DESIGN_CONCEPT.md` ya declara pendiente.
