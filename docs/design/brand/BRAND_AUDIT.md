...
- Adicionalmente: `docs/README.md`, `docs/archive/assessments/PROJECT_INVENTORY.md`, `docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` (auditoría documental previa, 2026-08-02) y `CLAUDE.md` (raíz).
...
|---|---|---|
| `docs/archive/foundational-book/0. Carta del Fundador.md` | Texto completo | Consolidado (fuente narrativa primaria) |
| `docs/archive/foundational-book/01-acto-el-origen/02-Como-Comenzo-Todo.md` | "Un invierno como tantos otros", "Una duda que cambió todo" | Consolidado — desarrolla la misma historia con más detalle |
| `docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` | Tabla 1.1 | Confirma que el Libro es "vigente como narrativa, sin versión formal" y "sin fecha en ningún archivo" |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/01-acto-el-origen/01-Introduccion.md` | Epígrafe e introducción del Acto | Consolidado |
| `docs/archive/foundational-book/01-acto-el-origen/05-La-Decision.md` | "El verdadero comienzo" | Consolidado |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/00-front-matter/00-Clausula-Cero.md` | Texto completo | — |
| `docs/enterprise/strategy/VISION_2030.md` | Sección "Propósito" | — |
| `docs/product/definition/PRODUCT_CANVAS.md` | Sección "Propósito" | — |
| `docs/product/VISION.md` | "Nuestra razón de existir" | — |
| `docs/archive/foundational-book/01-acto-el-origen/04-El-Descubrimiento.md` | "Mucho más que tecnología" | — |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/01-acto-el-origen/06-Nuestra-Promesa.md` | "La promesa que guía cada decisión" | Formulación emocional: *"Ayudar a que las personas enfrenten uno de los momentos más delicados de sus vidas con una preocupación menos"* |
| `docs/enterprise/strategy/VISION_2030.md` | "Nuestra Misión" | Formulación de infraestructura: *"Construir la mejor infraestructura tecnológica para democratizar el acceso a información farmacéutica de calidad"* |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/enterprise/strategy/VISION_2030.md` | "Nuestra Visión" | Fuente más completa, única con metadata de versión |
| `docs/product/VISION.md` | "Visión" | Formulación distinta, más corta |
| `docs/product/definition/PRODUCT_CANVAS.md` | "Visión de largo plazo" | Casi idéntica a la de ROADMAP.md |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/enterprise/strategy/VISION_2030.md` | Documento completo | Consolidado — único documento del repositorio con metadata formal de versión ("Versión 1.0", "Estado: Vivo", "Última actualización: Agosto 2026") |
...
| `docs/product/strategy/COMPANY_STRATEGY.md` | Sección 3 (modelos de negocio) | Única mención explícita de "valor de marca": *"choca directo con PRODUCT_PRINCIPLES.md (neutralidad es un valor de marca explícito)"* |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/02-acto-la-identidad/08-La-Constitucion.md` | 8 artículos | Fundacional / cultural |
| `docs/archive/foundational-book/03-acto-nuestra-forma-de-trabajar/22-El-Credo-De-ComparaFarma.md` | "Creemos que..." (11 líneas) | Síntesis del Libro |
| `docs/archive/foundational-book/appendix/Los-12-Principios-Inmutables.md` | 12 principios numerados (I–XII) | Fundacional / cultural, distinto de la Constitución |
| `docs/product/PRODUCT_PRINCIPLES.md` | 10 principios numerados | Operativo de producto |
| `docs/enterprise/strategy/VISION_2030.md` | "Principios Estratégicos" (5) | Operativo de arquitectura/datos |
| `docs/enterprise/strategy/MASTER_DATA_STRATEGY.md` | "3. Principios" (4) | Operativo de gobierno de datos |
| `docs/enterprise/strategy/PHARMACY_NETWORK_STRATEGY.md` | "2. Principios" (3) | Operativo de red de farmacias |
| `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` | "Principios Fundacionales" (9) | Operativo de patrimonio digital |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/0. Carta del Fundador.md` | Epígrafe y cierre: *"No podemos quitarte esa preocupación. Pero sí podemos quitarte otra"* | — |
| `docs/archive/foundational-book/01-acto-el-origen/06-Nuestra-Promesa.md` | Capítulo completo | — |
| `docs/archive/foundational-book/appendix/La-Promesa.md` | Documento completo (5 pares "No prometemos X / Prometemos Y") | — |
...
| `docs/product/definition/PRODUCT_CANVAS.md` | "Propuesta de Valor" | *"Permitir que cualquier persona encuentre el medicamento que necesita al mejor precio disponible en pocos segundos"* |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/enterprise/strategy/VISION_2030.md` | "Qué NO somos" / "Qué sí somos" | *"ComparaFarma NO pretende convertirse en: una farmacia; un marketplace; un sistema de recetas médicas; una plataforma de publicidad farmacéutica"* |
| `docs/product/VISION.md` | "Qué NO somos" | Formulación equivalente, algo más corta |
| `docs/product/definition/PRODUCT_CANVAS.md` | "Qué NO hacemos" | Formulación equivalente |
...
| `docs/archive/foundational-book/03-acto-nuestra-forma-de-trabajar/01-Introduccion.md` | *"Nosotros no escribimos este libro para inspirar. Lo escribimos para orientar decisiones"* | Aclara la función del texto, no define "voz" como concepto de marca |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/product/definition/PERSONAS.md` | 4 personas con nombre (Carmen, Rodrigo, Daniela, Claudia) | — |
| `docs/product/definition/PRODUCT_CANVAS.md` | "Público objetivo" (primario/secundario, incluye B2B) | — |
| `docs/product/SUBSCRIPTION_STRATEGY.md` | "Segmentación esperada" (5 segmentos) | — |
| `docs/archive/foundational-book/02-acto-la-identidad/04-Las-Personas-Antes-Que-Las-Metricas.md` | Descripciones narrativas de audiencia sin segmentación formal | — |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/product/definition/PRODUCT_CANVAS.md` | "Diferenciadores" | Lista explícita: comparación multi-farmacia, información objetiva, plataforma neutral, actualización frecuente, experiencia simple |
| `docs/archive/foundational-book/02-acto-la-identidad/05-La-Independencia-Antes-Que-La-Rentabilidad.md` | — | *"Nunca venderemos una posición privilegiada en nuestros resultados"* |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/03-acto-nuestra-forma-de-trabajar/17-Nuestro-Verdadero-Competidor-Es-La-Desinformacion.md` | Capítulo completo | Única definición explícita: *"Nuestro verdadero competidor es la desinformación"* |
| `docs/archive/foundational-book/01-acto-el-origen/03-El-Problema.md` | — | *"En ComparaFarma nunca nos propusimos ganar una competencia entre farmacias"* |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/00-front-matter/00-Clausula-Cero.md`, `docs/enterprise/strategy/VISION_2030.md`, `docs/product/definition/PRODUCT_CANVAS.md`, `docs/product/ROADMAP.md`, `docs/archive/foundational-book/02-acto-la-identidad/09-Manifiesto.md` | Múltiples secciones | *"Ayudar a las personas a tomar mejores decisiones"* — la frase mejor consolidada de todo el corpus |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/02-acto-la-identidad/09-Manifiesto.md` | Cierre | Única mención de ComparaFarma como marca, y aparece subordinada: *"Antes de ser una aplicación... Antes de ser una empresa... Antes de ser una marca..."* |
| `docs/product/strategy/COMPANY_STRATEGY.md` | Sección 3 | Mención indirecta de "valor de marca" (ver Valores) |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/product/definition/PRODUCT_CANVAS.md`, `docs/product/VISION.md`, `docs/product/ROADMAP.md` | Completos | Consolidado — evolución "comparador → plataforma de inteligencia farmacéutica" consistente |

### Empresa

| Documento | Ubicación | Estado |
|---|---|---|
| `docs/product/strategy/COMPANY_STRATEGY.md` | "De app a empresa" | Define la evolución operativa/legal/comercial |
| `docs/archive/foundational-book/04-acto-el-legado/02-La-Empresa-Que-Queremos-Dejar.md` | — | Define "empresa" en sentido de legado, no operativo |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/enterprise/strategy/VISION_2030.md`, `docs/enterprise/strategy/MASTER_DATA_STRATEGY.md`, `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md`, `docs/enterprise/BUSINESS_CAPABILITY_MAP.md`, `docs/enterprise/BUSINESS_SERVICES.md`, `docs/enterprise/ENTERPRISE_DATA_MODEL.md`, `docs/product/ROADMAP.md` | Múltiples secciones | "Plataforma de Inteligencia Farmacéutica" — término idéntico repetido en 7 documentos de 3 dominios |
...
| Documento | Ubicación | Estado |
|---|---|---|
| `docs/archive/foundational-book/02-acto-la-identidad/08-La-Constitucion.md`, Art. I | — | *"La confianza será siempre el patrimonio más importante de ComparaFarma"* (patrimonio = confianza, activo emocional) |
| `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` | Documento completo | "Patrimonio Digital" — 5 categorías estructuradas de activos de conocimiento (DAR-100 a DAR-500) |
...
- `docs/archive/foundational-book/01-acto-el-origen/06-Nuestra-Promesa.md`: *"Nuestra misión... Ayudar a que las personas enfrenten uno de los momentos más delicados de sus vidas con una preocupación menos"* (énfasis emocional).
- `docs/enterprise/strategy/VISION_2030.md`, "Nuestra Misión": *"Construir la mejor infraestructura tecnológica para democratizar el acceso a información farmacéutica de calidad"* (énfasis en infraestructura tecnológica).
...
1. `docs/archive/foundational-book/appendix/Como-Tomar-Decisiones.md` — 7 preguntas, para "decisiones importantes" en general.
2. `docs/archive/foundational-book/appendix/El-Test-De-La-Confianza.md` — 7 preguntas distintas, para "toda nueva funcionalidad, alianza, campaña, decisión estratégica, innovación".
3. `docs/enterprise/strategy/VISION_2030.md`, "Cómo tomaremos decisiones" — 5 preguntas, para desarrollo de funcionalidades.
4. `docs/product/decisions/PRODUCT_DECISION_FRAMEWORK.md` (CFPS) — fórmula ponderada de 7 criterios (1–5), para priorización de producto.
5. `docs/enterprise/strategy/PHARMACY_NETWORK_STRATEGY.md`, "Criterios de incorporación" — matriz ponderada de 7 criterios, para incorporar farmacias.
6. `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md`, "Criterios para crear un nuevo Activo Digital" — checklist de 6 preguntas booleanas, para creación de activos digitales.
...
- En el Libro (`docs/archive/foundational-book/02-acto-la-identidad/08-La-Constitucion.md`, Art. I, y `docs/archive/foundational-book/02-acto-la-identidad/02-La-Confianza-Antes-Que-El-Crecimiento.md`): patrimonio = la confianza, un activo intangible/emocional. *"La confianza será siempre el patrimonio más importante de ComparaFarma."*
- En `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` y en `docs/enterprise/`: "Patrimonio Digital" = conocimiento estructurado y reutilizable (catálogo maestro, historial de precios, conocimiento de mercado, conocimiento de uso, conocimiento comercial), explícitamente definido por exclusión de lo emocional: *"La identidad civil de una persona no constituye un Activo Digital"* (no se menciona la confianza como categoría de Patrimonio Digital en el DAR).
...
`docs/enterprise/strategy/VISION_2030.md`, `docs/product/VISION.md`, `docs/product/definition/PRODUCT_CANVAS.md` ("Visión de largo plazo": *"Convertir a ComparaFarma en la plataforma líder de inteligencia farmacéutica para personas en Chile"*) y `docs/product/ROADMAP.md` ("Visión": *"Convertir ComparaFarma en la plataforma líder de inteligencia farmacéutica para personas en Chile"* — difiere de la anterior en una sola palabra, "a"). Ninguno declara ser la fuente y los otros la copia.

**A2. Segmentación de audiencia en tres esquemas no reconciliados.**
`docs/product/definition/PERSONAS.md` (4 personas con nombre: Carmen, Rodrigo, Daniela, Claudia) no se mapea 1:1 con `docs/product/SUBSCRIPTION_STRATEGY.md` ("Usuario ocasional", "Familia", "Paciente crónico", "Adulto mayor", "Cuidador") ni con `docs/product/definition/PRODUCT_CANVAS.md` ("Público objetivo": categorías genéricas más un público secundario B2B — médicos, químicos farmacéuticos, aseguradoras — ausente en los otros dos documentos). Por ejemplo, Daniela ("profesional con poco tiempo", `PERSONAS.md`) no corresponde a ningún segmento nombrado en `SUBSCRIPTION_STRATEGY.md`, y "Usuario ocasional" (`SUBSCRIPTION_STRATEGY.md`) no tiene persona equivalente en `PERSONAS.md`.
...
`docs/product/VISION.md` (*"encuentre rápidamente la mejor alternativa disponible"*) vs. `docs/product/definition/PRODUCT_CANVAS.md` (*"encuentre el medicamento que necesita al mejor precio disponible en pocos segundos"*). Mismo espíritu, distinta redacción, sin fuente declarada.
...
El cierre de la Carta del Fundador (*"No podemos quitarte esa preocupación. Pero sí podemos quitarte otra"*), el capítulo extenso "Nuestra Promesa" (`docs/archive/foundational-book/01-acto-el-origen/06-Nuestra-Promesa.md`), y la síntesis formal de 5 pares en `docs/archive/foundational-book/appendix/La-Promesa.md` no se citan entre sí, aunque son consistentes en contenido.

### Bajo

**B1. Referencia retirada al nombre "LET".**
Según `docs/product/decisions/DECISION_LOG.md` (entrada 2026-08-02), se corrigió una premisa incorrecta sobre una supuesta cuenta de infraestructura "LET"/"letchile", y se eliminaron esas referencias de la documentación operativa. No es una inconsistencia de identidad de marca en sí, pero es relevante tenerlo presente al consolidar nombres oficiales para evitar reintroducir una referencia ya retirada.
...
|---|---|---|---|---|
| 1 | `docs/product/VISION.md` | `docs/enterprise/strategy/VISION_2030.md`, `docs/archive/foundational-book/00-front-matter/00-Clausula-Cero.md` | Propósito / Misión / Visión | `VISION_2030.md` como fuente operativa única (más completa, versionada); Cláusula Cero se mantiene como registro narrativo/fundacional (no reemplazable); **VISION.md → eliminar o convertir en referencia**. (Recomendación ya emitida por `AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` §3; este audit la confirma con evidencia adicional específica de marca) |
| 2 | `docs/product/definition/PRODUCT_CANVAS.md` ("Visión de largo plazo") | `docs/product/ROADMAP.md` ("Visión") | Enunciado de visión casi idéntico (difieren en una palabra) | **Convertir ambas en referencia** a `VISION_2030.md`; eliminar la reformulación local |
| 3 | `docs/archive/foundational-book/appendix/Como-Tomar-Decisiones.md` | `docs/archive/foundational-book/appendix/El-Test-De-La-Confianza.md`, `docs/enterprise/strategy/VISION_2030.md`, `docs/product/decisions/PRODUCT_DECISION_FRAMEWORK.md`, `docs/enterprise/strategy/PHARMACY_NETWORK_STRATEGY.md`, `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` | Marco de toma de decisiones (6 marcos) | **No fusionar** (ámbitos distintos: decisión personal/ética, funcionalidad de producto, incorporación de farmacias, activos digitales) — **sí declarar jerarquía y ámbito de cada uno**, con referencia cruzada explícita |
| 4 | `docs/archive/foundational-book/02-acto-la-identidad/08-La-Constitucion.md` | `docs/archive/foundational-book/03-acto-nuestra-forma-de-trabajar/22-El-Credo-De-ComparaFarma.md`, `docs/archive/foundational-book/appendix/Los-12-Principios-Inmutables.md` | Principios/valores fundacionales (solapamiento textual) | **Mantener las tres** (cumplen función retórica distinta: ley fundamental / síntesis diaria / lista atemporal) — **agregar nota cruzada explícita** que declare que son variaciones de un mismo conjunto |
| 5 | `docs/archive/foundational-book/appendix/Los-12-Principios-Inmutables.md` | `docs/product/PRODUCT_PRINCIPLES.md` | Principios (fundacional vs. operativo de producto) | **Mantener ambos** (ya se usan en la práctica, según `AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md`: *"Principio 7"* citado en actas/backlog) — **agregar referencia cruzada en ambos sentidos** (recomendación ya emitida por la auditoría documental previa) |
| 6 | `docs/archive/foundational-book/01-acto-el-origen/06-Nuestra-Promesa.md` | `docs/archive/foundational-book/appendix/La-Promesa.md` | La promesa de ComparaFarma (narrativa extensa vs. síntesis de 5 pares) | **Mantener ambas** — declarar cuál es la versión "citable"/oficial corta si se necesita una sola frase para uso externo |
| 7 | `docs/product/definition/PERSONAS.md` | `docs/product/definition/PRODUCT_CANVAS.md` ("Público objetivo"), `docs/product/SUBSCRIPTION_STRATEGY.md` ("Segmentación esperada") | Audiencias / segmentos (3 esquemas no reconciliados) | **Fusionar en un único mapa** de audiencias que relacione personas nombradas ↔ segmentos de negocio ↔ público objetivo general, señalando una única fuente |
| 8 | `docs/enterprise/strategy/VISION_2030.md` ("Nuestros activos estratégicos", 7 activos) | `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` (Patrimonio Digital, 5 categorías), `docs/enterprise/BUSINESS_CAPABILITY_MAP.md` / `ENTERPRISE_DATA_MODEL.md` (Activos Digitales) | Patrimonio / activos estratégicos | Ya señalado internamente por el propio repositorio (`docs/product/decisions/DECISION_LOG.md`, entrada 2026-08-04, y `docs/archive/assessments/PROJECT_INVENTORY.md` §9, ambos citados como evidencia primaria). **Fusionar/reconciliar**: el DAR es el más reciente y formal (cadena "Visión 2030 ↓ Digital Asset Register" declarada en los propios documentos enterprise) — VISION_2030 debería referenciar al DAR en lugar de mantener su propia enumeración de 7 activos |
...
- **Análisis de competencia real.** Existe una definición filosófica de "competencia" (`docs/archive/foundational-book/03-acto-nuestra-forma-de-trabajar/17-Nuestro-Verdadero-Competidor-Es-La-Desinformacion.md`: la desinformación, no una empresa), pero ningún documento nombra o analiza competidores reales (otras apps comparadoras, agregadores, iniciativas de farmacias).
- **Fuente única declarada para conceptos de marca.** A diferencia del resto del repositorio, que ya cuenta con una auditoría de gobierno documental general (`docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md`), no existe (hasta este documento) un mapa equivalente específico para qué documento es la fuente oficial de cada concepto de identidad de marca.
...
Idea inicial (un padre observa el gasto de invierno en medicamentos, sin fecha documentada)
        ↓
Carta del Fundador (docs/archive/foundational-book/0. Carta del Fundador.md — sin fecha en el archivo)
        ↓
...
Producto (docs/product/VISION.md, PRODUCT_CANVAS.md, PRODUCT_PRINCIPLES.md, PERSONAS.md
        ...
        ↓
Empresa (docs/product/strategy/COMPANY_STRATEGY.md, "De app a empresa", fechado 2026-07-19;
        SUBSCRIPTION_STRATEGY.md, ejecutado 2026-08-02 según DECISION_LOG)
        ↓
Estrategia / Visión 2030 (docs/enterprise/strategy/VISION_2030.md, "Última actualización: Agosto 2026" —
        el único documento del repositorio con metadata formal de versión)
        ↓
Patrimonio Digital (docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md, "Última actualización: 2026-08-03")
        ↓
...
- No existe una única fuente de verdad declarada para misión, visión, principios o marcos de decisión — el propio repositorio (`docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md`) ya diagnosticó la ausencia de "una única fuente de verdad declarada por tema" y la falta de "ciclo de vida ni versión formal en la mayoría de los documentos".
...
- La palabra "marca" se usa una sola vez para referirse a ComparaFarma, y en esa única aparición queda subordinada a "aplicación" y "empresa" (`docs/archive/foundational-book/02-acto-la-identidad/09-Manifiesto.md`).
...
No se propone crear el Brand Book todavía. Se indica, con base exclusiva en la evidencia de este informe (y en línea con lo ya recomendado por `docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` §3 y §8), qué documento debería ser la fuente oficial de cada tema:

| Tema | Fuente oficial recomendada | Nota |
|---|---|---|
| Propósito | `docs/enterprise/strategy/VISION_2030.md` (operativo) + `docs/archive/foundational-book/00-front-matter/00-Clausula-Cero.md` (narrativo/fundacional) | Ambos se mantienen — cumplen roles distintos (estratégico vs. cultural), no son duplicados a eliminar |
| Misión | `docs/enterprise/strategy/VISION_2030.md` (operativo) | Requiere decisión explícita del CEO: reconciliar con la formulación emocional del Libro y la económica de `product/VISION.md` (Hallazgo C1) |
| Visión | `docs/enterprise/strategy/VISION_2030.md` | Es ya el más completo y el único versionado formalmente |
| Valores / Principios | `docs/archive/foundational-book/appendix/Los-12-Principios-Inmutables.md` (fundacional) + `docs/product/PRODUCT_PRINCIPLES.md` (operativo de producto) | Mantener ambos con referencia cruzada explícita; la Constitución y el Credo quedan como registro ritual/narrativo, no como fuente operativa adicional |
...
| Estrategia | Cadena ya declarada por los propios documentos enterprise: `docs/archive/foundational-book/0. Carta del Fundador.md` → `docs/enterprise/strategy/VISION_2030.md` → `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` → `docs/enterprise/BUSINESS_CAPABILITY_MAP.md` → `docs/enterprise/BUSINESS_SERVICES.md` → `docs/enterprise/ENTERPRISE_DATA_MODEL.md` | Tratar esta cadena como jerarquía vigente hasta que se decida lo contrario |
...
- La sección "Visión de largo plazo" de `docs/product/definition/PRODUCT_CANVAS.md` y la sección "Visión" de `docs/product/ROADMAP.md` — deberían referenciar `VISION_2030.md` en vez de restablecer el enunciado.
- La lista de "7 activos estratégicos" de `docs/enterprise/strategy/VISION_2030.md` — debería referenciar `docs/enterprise/strategy/DIGITAL_ASSET_REGISTER.md` en lugar de mantener su propia enumeración paralela.
...
2. **Consolidación documental previa** — ejecutar las decisiones pendientes ya señaladas por `docs/archive/audits/AUDIT_DOCUMENTAL_GOBIERNO_CONOCIMIENTO_2026-08.md` y por la sección 8 de este informe (fuente única por tema, versionado de `docs/strategy/*`, jerarquía explícita entre los seis marcos de decisión)
3. **BRAND_BOOK**
4. **VISUAL_IDENTITY**
5. **BRAND_GUIDELINES**
6. **GOOGLE_PLAY_BRAND**
