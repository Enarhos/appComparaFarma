# DESIGN BRIEF — ComparaFarma

**Pregunta que responde este documento: ¿qué debe diseñar exactamente un diseñador para representar correctamente a ComparaFarma?**
...
|---|---|
| **Código** | DES-BRF-001 |
| **Nombre** | DESIGN_BRIEF.md |
| **Dominio** | Arquitectura de Diseño (`docs/design/`) |
| **Estado** | Activo |
| **Versión** | 1.0 |
| **Propietario** | CEO / CTO |
| **Rol asumido en su redacción** | Creative Director / Brand Strategist / Design Director |
...
Este documento traduce la identidad de marca ya definida (Fundación, Visión, Producto, Brand, Enterprise) en un encargo de diseño operable: la información mínima y suficiente para que un estudio de diseño o un diseñador senior, sin haber participado en ninguna de las sesiones estratégicas de ComparaFarma, pueda iniciar el proceso de diseño de la identidad visual con total fidelidad a lo ya decidido, y con total libertad creativa sobre lo que todavía no se ha decidido (forma, color, tipografía).

No inspira. No convence. Encarga.
...
### 4.2 Alcance del Design Brief

**Qué define:**
- El contexto, la identidad, la personalidad y las restricciones ya decididas que el diseño debe respetar.
- Los criterios con los que se evaluarán las propuestas.
- Los entregables esperados del proceso de diseño.
...
El problema concreto que resuelve (`docs/product/PRODUCT_DEFINITION_v1.0.md`): *"una misma receta médica puede presentar diferencias importantes de precio entre distintas farmacias. La mayoría de las personas desconoce estas diferencias y termina comprando donde consulta primero, sin información suficiente para optimizar su gasto."* Su propuesta de valor: *"conocer, en pocos segundos, dónde un medicamento tiene el mejor precio disponible entre distintas farmacias, facilitando decisiones de compra más inteligentes y contribuyendo al ahorro familiar mediante información objetiva y transparente."*

En términos de qué construye la organización detrás de esa promesa (`docs/enterprise/BUSINESS_CAPABILITY_MAP.md`, `BUSINESS_SERVICES.md`): capacidades de Gestión del Conocimiento Farmacéutico, Comparación Inteligente e Inteligencia Farmacéutica, sostenidas por servicios de normalización, matching y comparación de precios — es decir, una organización construida alrededor de **procesar información compleja para devolverla simple**, no alrededor de vender, transaccionar o prescribir.
...
Lo que la marca representa, en una frase que un diseñador puede sostener durante todo el proceso: **una fuente de orientación e información objetiva que existe para que las personas decidan con menos incertidumbre y menos costo, no una tienda, no un intermediario comercial y no una autoridad médica.**
...
- **Hospital / Clínica** — `DESIGN_CONCEPT.md` §4.5: el territorio visual "no pertenece a" farmacia/clínica.
- **Marketplace / e-commerce transaccional** — "no somos un marketplace", categoría explícitamente descartada en `BRAND_FOUNDATIONS.md` §13.
- **Empresa estatal / autoridad regulatoria** — `DESIGN_CONCEPT.md` §4.7 restringe "sellos o insignias de autoridad regulatoria/gubernamental"; `VISUAL_IDENTITY.md` §4.7 excluye "Portal gubernamental" por extensión de categoría.

No se agregan aquí otras categorías (aseguradora financiera, medio de publicidad) porque, aunque están mencionadas puntualmente en las fuentes, ya quedan cubiertas por las cinco anteriores; se listan en detalle en la sección 4.10 (Restricciones).
...
- **Honesta, incluso al costo de la conveniencia** — *"preferimos una verdad imperfecta antes que una ilusión perfecta."*
- **Prudente** — *"preferimos reconocer una incertidumbre antes que ofrecer una falsa certeza."*
- **Racional, no jerárquica en sus argumentos** — *"queremos que dependan de la solidez de los argumentos."*
- **Respetuosa de la autonomía de quien decide** — *"una buena experiencia ayuda a decidir. Nunca empuja a decidir."*

**Pendiente de definición, y por lo tanto fuera de este brief:** un arquetipo de marca formal y una lista cerrada y priorizada de rasgos ratificada por el CEO/fundador — ninguno existe hoy en la documentación (`BRAND_AUDIT.md` §5).

### 4.7 Emociones

Máximo cinco, cada una justificada directamente en las fuentes — no una lista de aspiraciones genéricas de branding:
...
|---|---|
| Claridad | "La claridad antes que la complejidad" |
| Simplicidad | Principio operativo de producto ("Simplicidad") |
| Confianza | "La confianza antes que el crecimiento" |
| Transparencia | "Mostrar la información de la forma más clara y útil posible" |
| Accesibilidad | Principio operativo de producto |
| Humanidad | "Detrás de cada medicamento existe una persona" |
| Inteligencia | Naturaleza de "Plataforma de Inteligencia Farmacéutica" |
| Evidencia | "La evidencia antes que el ego" |
| Neutralidad | "No privilegiamos una farmacia por sobre otra por conveniencia comercial" |

`VISUAL_IDENTITY.md` §4.3 agrega, como **atributos** (cómo debe sentirse, no principios de conducta): con respaldo directo — **Cercana, Confiable, Científica, Profesional**; por extensión razonable — **Limpia**; marcados explícitamente como pendientes de definición (sin evidencia documental) — Moderna, Optimista. Este brief no resuelve esos dos pendientes; los señala para que el proceso de diseño no los asuma como ya decididos.

### 4.9 Metáfora Central
...
- **Constelación / Conexión** — sugiere múltiples puntos dispersos (análogos a las 9 farmacias y sus precios) que, vistos en conjunto, forman un patrón legible.

Este brief no elige entre las tres. Evaluarlas —o proponer una interpretación alternativa del concepto "Orientación" coherente con las restricciones de la sección 4.10— es exactamente el primer entregable que se espera del proceso de diseño (sección 4.14).

**Metáforas ya descartadas, para que no se reexploren sin razón nueva:** Lente y Faro (sin respaldo textual directo, o con un rol más directivo/autoritario que el que ComparaFarma quiere transmitir); Red, Puente y Prisma (descartadas por colisión semántica con red comercial de farmacias, intermediación tipo marketplace, y proceso conceptualmente inverso, respectivamente) — `DESIGN_CONCEPT.md` §4.4.
...
- Signos de dinero, monedas, etiquetas de oferta/descuento.
- Candados, escudos de "seguridad" tipo fintech.
- Redes o nodos que sugieran una red comercial de farmacias.
- Elementos de urgencia agresiva (cuentas regresivas, "compra ahora", badges de urgencia).
- Puentes o conectores entre dos partes de una transacción.
...
- **Tipografía:** sin ningún sistema definido todavía (`TYPOGRAPHY_SYSTEM` no existe). Debe priorizar legibilidad en pantallas pequeñas — el producto es de uso móvil intensivo — sosteniendo a la vez los atributos "Clara" y "Científica/Profesional" sin volverse fría.
- **Ilustraciones (si se usan):** centradas en personas y momentos familiares y cotidianos, coherente con "detrás de cada medicamento existe una persona" — nunca escenarios clínicos, de laboratorio o de urgencia.
- **Fotografía (si se usa):** mismo criterio que ilustraciones — personas reales en contextos domésticos/familiares, nunca batas blancas ni entornos hospitalarios.
- **Composición:** el sistema debe sostener, con claridad, la convivencia de información numérica y comparativa densa (precios, farmacias, canales de precio) — la jerarquía visual de la información es, para este producto, tan parte de la "identidad" como cualquier elemento gráfico.
...
- **Documentos y presentaciones:** ya cubiertos por `VISUAL_IDENTITY.md` §4.5 — requieren que el sistema funcione también en fondo blanco/impreso, no solo en interfaz digital con color de marca de fondo.

### 4.13 Criterios de Evaluación

Matriz objetiva para evaluar propuestas de identidad, con ponderación. Los ocho criterios son los solicitados; la ponderación refleja las prioridades ya evidenciadas en la documentación (fidelidad de marca y legibilidad multiplataforma por encima de diferenciación estética).

| Criterio | Ponderación | Qué evalúa |
|---|---|---|
| Coherencia con la marca | 20% | ¿La propuesta respeta la personalidad (4.6), las emociones (4.7), los principios (4.8) y las restricciones (4.10) de este brief? |
| Legibilidad | 15% | ¿Se mantiene clara en los tamaños más pequeños de los escenarios de uso (favicon, ícono de sistema, avatar)? |
| Simplicidad | 15% | ¿Es tan simple como exige el principio "la claridad antes que la complejidad"? |
| Adaptabilidad digital | 13% | ¿Funciona en interfaz móvil, web, redes sociales y notificaciones sin perder identidad? |
| Escalabilidad | 12% | ¿El sistema (no solo el logo) escala a nuevos productos/canales sin romperse, coherente con el modelo Branded House? |
| Diferenciación | 10% | ¿Se distingue de las categorías de las que la marca debe alejarse (sección 4.5/4.10), y de otras apps del rubro? |
| Memorabilidad | 10% | ¿Es reconocible y recordable tras una exposición breve? |
| Atemporalidad | 5% | ¿Evita tendencias gráficas de vida corta que envejezcan mal para una plataforma pensada a 2030? |
| **Total** | **100%** | |

### 4.14 Entregables Esperados

Se solicita al diseñador o estudio:

1. **Exploración de múltiples familias conceptuales.** Pueden partir de las tres ya identificadas (Brújula, Mapa/Ruta, Constelación — sección 4.9) o proponer interpretaciones alternativas del concepto aprobado "Orientación", siempre dentro de las restricciones de la sección 4.10.
2. **Generación de múltiples propuestas visuales** dentro de al menos una de las familias exploradas, no una sola alternativa por familia.
...
Ninguna decisión de este documento tiene, ni pretende tener, el peso de una ratificación de marca — esa ratificación (pendiente sobre `BRAND_FOUNDATIONS.md` y `BRAND_ARCHITECTURE.md`, `docs/program/DECISION_QUEUE.md` DQ-007) es independiente de este brief y no lo bloquea: un Design Brief no necesita que la marca esté ratificada para poder encargar diseño sobre lo ya documentado.
...
|---|---|---|---|---|---|
| 1.0 | 2026-08-06 | Activo | Pendiente (CEO/fundador) | Creación inicial del Design Brief — encargo de diseño de la identidad visual de ComparaFarma, construido íntegramente como consecuencia de la documentación estratégica y de marca ya existente, sin diseñar ni reinterpretar. | Ver Matriz de Trazabilidad (§6) |
...
|---|---|---|---|
| 2026-08-06 | Redacción del Design Brief oficial de identidad visual | Creative Director / Brand Strategist / Design Director | `docs/design/DESIGN_BRIEF.md` v1.0 (este documento) |

**Pendiente de definición:** ninguna aprobación formal del CEO/fundador registrada todavía. Este documento debe convertirse en la única referencia autorizada para iniciar el proceso de diseño visual de la marca (Workstream A de `docs/program/CURRENT_SPRINT.md`).
