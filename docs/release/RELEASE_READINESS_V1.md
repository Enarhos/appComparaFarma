...
| 5.6 | CORS | 🟡 Parcial | Media | Vercel permite CORS por defecto. Sin configuración que restrinja orígenes. La API key protege parcialmente. | Para API mobile pública es aceptable. Si se agrega dashboard web futuro, restringir CORS a dominios propios. |
