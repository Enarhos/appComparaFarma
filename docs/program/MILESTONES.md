...
| 2026-08-02/03 | Subscription Platform — Fase 1 (motor + Google Play adapter) y Fase 2 (Web Billing) implementadas y mergeadas | `docs/product/EPICS.md` | Fase 2 corregida de Stripe a Flow por incompatibilidad con Chile |
