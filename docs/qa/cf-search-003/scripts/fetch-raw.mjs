/**
 * CF-SEARCH-003 — captura RAW read-only del endpoint publico de busqueda.
 *
 * Uso:  node docs/qa/cf-search-003/scripts/fetch-raw.mjs
 *
 * - GET publico, sin headers de autenticacion, sin cookies, sin secretos.
 * - No usa ?debug=1 (requiere API_SECRET_KEY; no se usa ni se solicita).
 ...
 *
 * Mismo metodo que CF-QA-001 (docs/qa/search-product-identity/analysis/
 * fetch-raw.mjs). No forma parte del runtime.
 */
...
async function main() {
  ...
  const queries = [...cfg.required, ...cfg.investigation];
